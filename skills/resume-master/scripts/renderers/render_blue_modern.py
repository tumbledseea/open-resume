#!/usr/bin/env python
"""Render template7 LaTeX from structured resume modules."""
...
def render_to_output(modules_path: Path, output_path: Path) -> tuple[Path, Path]:
    ...
    cls_output = output_path.parent / "blue_modern.cls"
    shutil.copy2(CLASS_PATH, cls_output)
    return output_path, cls_output


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Render template7 LaTeX from resume modules")
