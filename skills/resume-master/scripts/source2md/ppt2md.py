...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python ppt2md.py slides.pptx
  python ppt2md.py slides.pptx -o output.md
  python ppt2md.py ./decks
  python ppt2md.py ./decks -o ./markdown
  python ppt2md.py deck.ppsx -o notes/deck.md
